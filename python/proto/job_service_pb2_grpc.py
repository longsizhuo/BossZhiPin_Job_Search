...
class JobServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.TestConnection = channel.unary_unary(
                '/job_service.JobService/TestConnection',
                request_serializer=job__service__pb2.TestConnectionRequest.SerializeToString,
                response_deserializer=job__service__pb2.TestConnectionResponse.FromString,
                )
...
def add_JobServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'TestConnection': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=job__service__pb2.TestConnectionRequest.FromString,
                    response_serializer=job__service__pb2.TestConnectionResponse.SerializeToString,
            ),
...
class JobService(object):
    ...
    def TestConnection(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/job_service.JobService/TestConnection',
            job__service__pb2.TestConnectionRequest.SerializeToString,
            job__service__pb2.TestConnectionResponse.FromString,
