...
def send_job_descriptions_to_chat(url, browser_type, label, models, client_openAI = None, assistant_id=None, vectorstore=None):
    # 开始浏览并获取工作描述
            ...
            if job_description:
                ...
                if element == '立即沟通':
                    ...
                    if models == "deepseek":
                        ...
                        response = chat(job_description, client_openAI, assistant_id)
                    print(response)
                    time.sleep(1)
                    # 点击沟通按钮
